...
class DataManagement():
    ...
    def Read_Data(self,prot1,prot2,type='models',models =(0,1),RMSD=True):
        ...
        if type == 'models':
            ...
            X2_coordinates = self.Extract_coordinates_from_PDB('{}'.format(prot2),type)[models[0]]
        elif type == 'chains':
            X1_coordinates = self.Extract_coordinates_from_PDB('{}'.format(prot1),type)[models[0]][0:50]
            X2_coordinates = self.Extract_coordinates_from_PDB('{}'.format(prot2),type)[models[0]][0:50]
        ...
        ax.legend()
        plt.savefig(r"images/Theseus-PP/Initial.png")
    ...
    def Pymol(self,*args):
        ...
        pymol.cmd.png("images/Theseus-PP/TheSuperposition_Pymol")
class SuperpositionModel():
    ...
    def Run(self,data_obs,average,name):
        ...
        def update_progress(svi_engine):
            ...
            plt.plot(loss_list)
            plt.savefig(r"images/Theseus-PP/ELBO_Loss.png")
            plt.close()
        ...
        ax.legend()
        plt.savefig(r"images/Theseus-PP/Superposition_Result_Matplotlib_{}".format(name))
        ...
        plt.savefig(r"images/Theseus-PP/Distance_Differences_{}".format(name))
        plt.close()
